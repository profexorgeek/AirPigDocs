...
{% hint style="success" %}
Armor isn't limited to actual armor! Since it can be attached to any Bone with any sprite, it's also how you create hair, clothing, and other cosmetic attachments - see the examples on the [engine overview page](README.md).
{% endhint %}
...
{% hint style="danger" %}
Screenshot needed: the Armor/Weapon tabs with the filterable item list.
{% endhint %}
...
{% hint style="danger" %}
Screenshot needed: the shared item fields, including the bone attachment section.
{% endhint %}
...
{% hint style="danger" %}
Screenshot needed: the Weapon-specific fields, both melee and ranged states.
{% endhint %}
