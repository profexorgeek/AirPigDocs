...
{% hint style="danger" %}
Screenshot needed: the Animation list with the name/loop fields.
{% endhint %}
...
{% hint style="danger" %}
Screenshot needed: the playback controls and scrubber with keyframe markers visible.
{% endhint %}
...
{% hint style="danger" %}
Screenshot needed: the Bone list next to the Keyframe list.
{% endhint %}
...
{% hint style="danger" %}
Screenshot needed: the Keyframe pose properties panel, including sound and particle effect fields.
{% endhint %}
